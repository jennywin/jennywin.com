          ...
          <Columns justify='between' size='large'>
            <Box pad='medium'>
              ...
              <List>
                ...
                <ListItem>I'm passionate about bridging the (empathy) gap across cross-functional teams to develop collaborative relationships.</ListItem>
            ...
            <Box pad='medium'>
              ...
              <Paragraph>
                While managing multiple projects in parallel, I serve as the bridge between clients, sales, delivery, and engineering. To win client trust, I develop an intimate knowledge of their needs, requirements, and data. What I do on the regular: client consultations, data analysis, develop workflows and processes, write scripts, and implement solutions.
              </Paragraph>
